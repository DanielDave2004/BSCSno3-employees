...
exports.createUser=(req,res)=>{
    ...
    connection.query('INSERT INTO userdata (first_name, last_name, email, gender, ip_address, course) VALUES (?,?,?,?,?,?)',[fname,lname,email,gender,ip_address, course],(err,result)=>{
        if(err) throw err;
